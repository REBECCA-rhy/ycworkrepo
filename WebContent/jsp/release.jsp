...
<div class="box">
    ...
    <div class="content">
        <div class="info">
            <img src="${pageContext.request.contextPath }/resource/image/0058.jpg" alt="..." class="img-circle" width="50px" height="50px" >
        ...
        <span class="operation">
           <a href="login.html"> <img src="image/comment.png"></a>
            ...
            <a href="login.html"><img src="image/premium.png" border="1px solid red"></a>
        </span>
                </div>
            </label>
